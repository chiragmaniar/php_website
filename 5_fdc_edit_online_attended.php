			...
			<div class="form-group col-md-6">
                ...
                <form role="form" action = "" method = "POST">
				  ...
				  <div class="form-group">
                         ...
                         <textarea class="form-control input-lg" id="course" name="course" rows="2" <?php echo $course; ?>" readonly>
						<?php echo $course; ?>
						</textarea>
					 </div>
                  <div class="form-group">
                  ...
                  <div class="box-footer">
                    ...
                    <a href="2_dashboard_online_attended.php" type="button" class="btn btn-primary">Cancel</a>
