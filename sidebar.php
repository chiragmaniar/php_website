...
<aside class="main-sidebar">
  ...
  <section class="sidebar">
    ...
    <ul class="sidebar-menu">
      ...
      <li class="active treeview">
        <a href="#">
          <i class="fa fa-dashboard"></i> <span>Online Course</span>
          <span class="pull-right-container">
            <i class="fa fa-angle-left pull-right"></i>
          </span>
        </a>
        <ul class="treeview-menu">
          <li class="active"><a href="actcount_course_attended.php"><i class="fa fa-circle-o"></i>Add Attended Course</a></li>
          <li class="active"><a href="actcount_course_organised.php"><i class="fa fa-circle-o"></i>Add Organised Course</a></li>
