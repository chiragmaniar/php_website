...
<p>
                  ...
                  <div class="box-footer">
                    ...
                    <a href="2_dashboard.php" type="button" class="btn btn-warning btn-lg">Back to Home </a>
						...
						if(isset($_POST['count_total']))
						{
								...
								if (!empty($_POST['min_date']) && !empty($_POST['max_date']))
								{
										...
										else if($dateset== 0 && $a == 0)
										{
											...
											$sql1 = "select * from faculty where Date_from >= '$from_date' and Date_from <= '$to_date' and Fac_ID = $Fac_ID ";
											$display = 1;
										}
								}
								else
				...
				<?php 
					...
					if($count4 > 0)
					{
						if($set == 0)
						{
							...
							$sql1 = "select * from faculty where Fac_ID = $Fac_ID and Paper_type = 'conference' and Paper_N_I = 'national'" ;
						}
						else if($set == 1)
				...
				<tr> 
							...
							?></td>
							<td><?php 
							echo "<strong>Conference/Journal</strong>"."<br>";
							if($count4 == 0)
								echo "None";
							else{
							for($i = 0; $i<$count4; $i++)
...
<td><?php 
               ...
               <a href="print_your.php" type="button" class="btn btn-warning btn-lg" target="_blank">Print</a>
			<?php 
			}//end of if
			?>
                </form>
