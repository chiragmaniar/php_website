  ...
  $query = "SELECT Fac_ID from facultydetails where Email='".$_SESSION['loggedInEmail']."';";
	...
	$sql = "update faculty set Paper_title = $paperTitle,
			...
			if ($conn->query($sql) === TRUE) {
				...
				{
					$sql="select * from faculty where paper_title = $paperTitle";
					...
					$sql1="INSERT INTO fdc(Fac_ID,Paper_title) VALUES ($author1,$paperTitle)";
    ...
    <section class="content">
          <div class="row">
            ...
            <div class="col-md-6">
              ...
              <p>  <form role="form" method="POST" class="row" action ="" style= "margin:10px;" >
